...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>This is your Faculty Dashboard!!!</h2>
         <div class="col-md-3 sidebar">
            <h4 class="text-white ps-3">Admin Panel</h4>
            <a href="LogoutServlet">Logout</a>
        </div>
        <a href="AddFaculty.jsp" class="btn btn-success">+ Add Faculty</a>
    </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="EditFaculty.jsp?id=<%= rs.getInt("id") %>" class="btn btn-sm btn-primary">Edit</a>
                        <a href="DeleteFaculty?id=<%= rs.getInt("id") %>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
                <%
                        }
